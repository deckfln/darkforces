...
namespace GameEngine
{
	...
	class Collider
	{
		...
		static bool collision_fwAABB_segment(const Collider& aabb,
			const Collider& segment,
			std::vector<gaCollisionPoint>& collisions);		// do an aabb vs segment
	...
	public:
		...
		float collision(const glm::vec3& start,
			const glm::vec3& end,
